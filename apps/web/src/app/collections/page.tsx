...
/**
 * /collections - 系列总览页
 * 列出所有系列 (Tibetan/Thai Wind/Fusion) + 品类入口
 */
export const metadata: Metadata = {
  title: 'All Collections',
  description: 'Explore Nara Charm collections by tradition — Tibetan, Thai Wind, Fusion, and more. Handmade heritage jewelry.',
};
...
const CATEGORIES = [
  { slug: 'phone-charms', name: 'Phone Charms', icon: '📱', desc: 'Silk & cord charms' },
  { slug: 'necklaces', name: 'Necklaces', icon: '📿', desc: 'Beaded & pendant' },
  { slug: 'bracelets', name: 'Bracelets', icon: '⭕', desc: 'Stretch & cord' },
  { slug: 'earrings', name: 'Earrings', icon: '👂', desc: 'Studs & drops' },
];
